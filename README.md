...
[![CI](https://github.com/anmoliot/SOCv2/actions/workflows/soc-lab-ci.yml/badge.svg)](https://github.com/anmoliot/SOCv2/actions) [![MITRE ATT&CK](https://img.shields.io/badge/MITRE-ATT%26CK-red)](https://attack.mitre.org/)
...
```bash
git clone https://github.com/anmoliot/SOCv2.git
cd SOCv2
```
...
*Enterprise Detection Engineering SOC Lab · 12 tools · 100% open-source · MITRE ATT&CK v14*
...
**Anmol Gupta**
- GitHub: [@anmoliot](https://github.com/anmoliot)
- Email: anmol.23iot@cambridge.edu.in
